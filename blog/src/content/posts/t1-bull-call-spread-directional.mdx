...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a bull call spread in simple terms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You buy a call option at a lower strike and sell a call option at a higher strike on the same underlying and expiry. You pay a net debit, and your profit rises as the underlying rises, but it is capped above the higher strike."
      }
    },
    {
      "@type": "Question",
      "name": "How is a bull call spread different from buying a call?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Selling the higher-strike call lowers your cost and breakeven compared with a naked call, but it also caps your maximum profit. It is a defined-risk trade with lower capital outlay."
      }
    },
    {
      "@type": "Question",
      "name": "What is the maximum loss and maximum profit?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Max loss is the net debit paid. Max profit is the strike width minus the net debit, minus all costs. Both are known at entry."
      }
    },
    {
      "@type": "Question",
      "name": "What is the breakeven point of a bull call spread?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "At expiry, the breakeven is the long strike plus the net debit per unit. In the example, that is 22,000 + ₹70 = 22,070."
      }
    },
    {
      "@type": "Question",
      "name": "When should I use a bull call spread?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Use it when you expect a moderate upward move, not a parabolic rally, and when you want to reduce the cost and time-decay risk of a long call."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if the short call expires in the money on a stock option?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Stock options in India are physically settled. If your short call is in the money at expiry, you may have a delivery obligation. This is very different from the cash-settled index version."
      }
    },
    {
      "@type": "Question",
      "name": "How do I choose the strikes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with a lower strike near or slightly above the money and a higher strike that matches your upside target. Wider spreads cost more but raise max profit; tighter spreads lower cost but also lower payoff."
      }
    }
  ]
}
