...
description: "Paper trading looks profitable. Live capital isn't. Slippage, STT, SEBI margin rules, and your own reactions change the system. Here's how to fix the process before you fund."
takeaway: "Paper trading looks profitable. Live capital isn't. Slippage, STT, SEBI margin rules, and your own reactions change the system. Here's how to fix the process before you fund."
...
## Backtest and paper trade on Āagman

Before you fund the account, run the same strategy on Āagman with real costs and slippage.

Backtest it with realistic slippage and costs:

```
Backtest an intraday Nifty 50 futures breakout strategy on 15-minute candles from Jan 2024 to Dec 2024. Enter long when price breaks above the previous 15-minute high. Exit at a 1:3 risk/reward or at a 1% stop loss. Then add 1 tick slippage per trade and the full cost stack: brokerage, STT, exchange charges, SEBI turnover fee, GST, and stamp duty.
```
...
Paper trade it on Āagman with live market data for at least 30 sessions. Run the same rules without changing them. If the fills and the cost drag match what you modeled, you have a live-ready process.
