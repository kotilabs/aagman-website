...
1. Log into Āagman.
2. Type your strategy in plain language — instrument, timeframe, dates, entry rule, exit rule.
...
7. Check the trade table for anything that looks off.
8. Tweak one thing and rerun — a filter, a period, a symbol.
9. Compare the option leg against the underlying for the same period.
10. If the numbers do not beat the simpler alternative, do not trade the option leg.
