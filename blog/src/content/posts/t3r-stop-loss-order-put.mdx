...
- [Market vs limit orders: the entry decision](./t3r-vs-limit-orders-entry) — how the order type you choose changes your entry fill.
- [What changes when you go from paper trading to live capital](./t4-changes-go-paper-live) — why stop rules feel different once real money is at risk.
- [Why most options buyers lose money](./why-options-buyers-lose-money) — how poor exits and slippage compound the buyer's edge problem.
- [Covered call strategy for Indian stocks](./covered-call-strategy-indian-stocks) — a defined-risk live strategy to practice stops with a slower pace.
